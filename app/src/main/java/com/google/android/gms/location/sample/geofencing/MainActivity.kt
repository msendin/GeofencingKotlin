...
import com.google.android.gms.location.sample.geofencing.GeofenceErrorMessages.getErrorString
 ...
 *
 */
class MainActivity : AppCompatActivity(), View.OnClickListener, OnCompleteListener<Void?> {
    /**
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.add_geofences_button) {
            if (!checkPermissions()) {
    ...
    override fun onComplete(task: Task<Void?>) {
        ...
        if (task.isSuccessful) {
            ...
            val errorMessage = getErrorString(this, task.exception)
